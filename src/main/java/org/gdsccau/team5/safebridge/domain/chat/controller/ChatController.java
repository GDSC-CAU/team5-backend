...
public class ChatController {
    ...
    private static final String TEAMLIST_SUB_URL = "/sub/team/";
    ...
    public void chat(final ChatMessageRequestDto chatRequestDto,
        ...
        // 4. 업데이트된 채팅방 리스트 데이터 전송하기 (실시간 변경)
     ...
     */
    @GetMapping("/chat/team/{teamId}/user/{userId}")
    public ApiResponse<Map<String, Object>> getMessages(
        ...
        return ApiResponse.onSuccess(ChatSuccessCode.FIND_CHAT_IN_TEAM,
                chatCheckService.findAllChatsByTeamId(cursorId, userId, teamId));
    }
}
